...
//         </header>
//         <div>
//           <p className="font-[Anta] 3xl:hidden text-center leading-6 text-base md:text-xl uppercase tracking-widest  text-[#8ceaea] drop-shadow-lg py-5">
//             Rise as the greatest galactic commander of the universe. Build your
//             own legacy among the stars
//           </p>
//             <p className="font-[Anta] 2xl:hidden text-6xl text-center leading-6 text-base md:text-xl uppercase tracking-widest  text-[#8ceaea] drop-shadow-lg py-5">
//             Rise as the greatest galactic commander of the universe. Build your
//             own legacy among the stars
//           </p>
  ...
  return (
    <>
      <section className="min-h-screen w-full flex flex-col justify-between pt-5 px-4 md:px-8 lg:px-24 bg-[url(/imgi_1_bg2.png)] bg-cover bg-no-repeat bg-center">
        ...
        {/* ======================= LOWER SECTION ============================ */}
        {/* ================================================================== */}
        <div className="h-[90vh] lg:h-[63vh]">
          ...
          <div className="flex md:hidden flex-col h-full"> {/* <-- This is now ONLY for mobile */}
            ...
            <div className="flex-grow w-full flex items-end justify-center bg-[url(/imgi_8_7.png)] bg-cover bg-no-repeat">
              <div className="flex flex-col items-center justify-center w-full z-10 pb-0">
                ...
                <button className="bg-[url(/imgi_9_6.png)] -mt-[120px] w-2/5 h-[28vh] bg-contain bg-no-repeat bg-center hover:scale-110 transition-transform"></button>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex lg:hidden flex-col h-full"> {/* <-- CHANGED: This new block is ONLY for tablets */}
            ...
            <div className="flex-grow w-full flex items-end justify-center bg-[url(/imgi_8_7.png)] bg-cover bg-no-repeat ">
              <div className="flex flex-col items-center justify-center w-full z-10 pb-10">
                ...
                <button className="bg-[url(/imgi_9_6.png)] -mt-42 w-2/7 h-[20vh] bg-contain bg-no-repeat bg-center hover:scale-110 transition-transform"></button>
              </div>
            </div>
          </div>
          ...
          {/* ------------------------------------------------------------------ */}
          <div className="hidden lg:flex 2xl:hidden h-full items-end gap-6"> {/* <-- CHANGED: This block now starts at `lg` */}
            ...
            <div className="w-1/2 h-full bg-[url(/imgi_8_7.png)] bg-contain bg-no-repeat bg-bottom flex flex-col items-center justify-end pb-5">
              ...
              <button className="bg-[url(/imgi_9_6.png)] bg-contain bg-no-repeat bg-center w-1/2 h-32 -mt-20 lg:-mt-24 hover:scale-110 transition-transform"></button>
            </div>
          </div>

          {/* ------------------------------------------------------------------ */}
          {/* ---------- LARGE DESKTOP DESIGN (1536px and up) ------------------ */}
          {/* ------------------------------------------------------------------ */}
          <div className="hidden 2xl:flex h-full items-end">
            <div className="w-2/3 3xl:w-3/4 flex flex-col justify-between h-full pt-8">
            ...
            <div className="w-1/3 3xl:w-14 h-full bg-[url(/imgi_8_7.png)] bg-contain bg-no-repeat bg-bottom">
              {/* This column is intentionally empty on large desktops to feature the character art */}
            </div>
          </div>
        </div>
      </section>
